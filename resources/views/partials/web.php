...
Route::middleware(['auth', 'role:karyawan'])->prefix('karyawan')->name('karyawan.')->group(function () {
    ...
    Route::get('/rekap', [KaryawanController::class, 'reports'])->name('reports.index');
    Route::post('/rekap', [KaryawanController::class, 'storeReport'])->name('reports.store');
    Route::get('/rekap/{report}/unduh', [KaryawanController::class, 'downloadReport'])->name('reports.download');
    Route::delete('/rekap/{report}', [KaryawanController::class, 'destroyReport'])->name('reports.destroy');
});
