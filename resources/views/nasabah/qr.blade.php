...
<div class="gg-card p-5 text-center">
    ...
    <div class="qr-box my-4">
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=280x280&data={{ urlencode($user->member_id) }}" alt="QR {{ $user->member_id }}" width="280" height="280">
    </div>
